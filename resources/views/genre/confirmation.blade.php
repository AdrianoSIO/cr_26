...
.confirmation-container h2 { margin-bottom: 20px; color: #333; }
.confirmation-container p { margin-bottom: 25px; font-size: 1rem; color: #555; }
...
.btn-keep { background-color: #f6ad55; color: white; }
.btn-keep:hover { background-color: #dd6b20; }
...
<div class="confirmation-container">
    ...
    @if($utilisateursCount > 0)
        ...
        <form method="POST" action="{{ route('genre.suppression', $genreModel->code) }}">
            @csrf
            @method('DELETE')
